...
to remove all of the vowels from the trolls' comments, neutralizing the threat.
...
function disemvowel(str) {
  //str = str.replace(/[\i\o\e\u\a\I\O\E\U\A]/g, ""); //заменил на строку ниже

  return console.log(str.replace(/[aioeu]/gi, ""));
}
